function results = predvariance21_rollingrho(usedata,usemats,numfac)
...
results.rho_vec_perchigh=prctile(rho_vec_boot',97.5);
results.rho_vec_perclow=prctile(rho_vec_boot',2.5);
